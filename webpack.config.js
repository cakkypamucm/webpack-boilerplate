...
const hmrCssFixStripHash = (pattern) => pattern.replaceAll(/-?\[(fullhash|chunkhash|hash|contenthash)(:\d+)?\]/g, "");
...
export default (_, argv) => ({
    ...
    plugins: [
        ...
        new MiniCssExtractPlugin({
            filename: `${assetsPath}/css/${argv.mode === "production" ? uniqueFileName : hmrCssFixStripHash(uniqueFileName)}.css`,
            chunkFilename: `${assetsPath}/css/${argv.mode === "production" ? uniqueFileChunkName : hmrCssFixStripHash(uniqueFileChunkName)}.css`
        })
    ],
    optimization: {
